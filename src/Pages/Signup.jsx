// Signup.jsx - Updated with modern purple/pink theme
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 shadow-2xl shadow-purple-500/20 p-8 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">Start creating amazing startup pitches with AI</p>
        </div>
        ...
        <div className="mb-6 bg-white/5 rounded-2xl p-4 border border-white/10">
          <h3 className="text-purple-300 font-semibold mb-3 text-center">What you'll get:</h3>
        ...
        {/* Signup Form */}
        <SignupForm data={getData} loading={loading} />
